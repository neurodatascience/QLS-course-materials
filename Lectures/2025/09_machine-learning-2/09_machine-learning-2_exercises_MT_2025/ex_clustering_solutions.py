...
visualize_kmeans(data=X, n_clusters=n_digits)
...
#   - Answer: The data separates relatively well into clusters based on the visualization and ARI score.
...
#             But the ARI and silhouette scores decreased in most cases.
...
#   - Answer: The optimum number of clusters found using ARI and silhouette scores were different from the true number of clusters.
