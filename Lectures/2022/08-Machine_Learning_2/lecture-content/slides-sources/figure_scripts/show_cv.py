...
TEST_CMAP = colors.ListedColormap([EMPTY_COLOR, colors.TABLEAU_COLORS["tab:orange"]])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--outer_k", type=int, default=5, help="Number of folds in outer loop")
    parser.add_argument(
        "--inner_k",
        type=int,
        default=3,
        help="Number of folds in inner loop " "(used for hyperparameter selection)",
    )
    parser.add_argument(
        "--simple",
        action="store_true",
