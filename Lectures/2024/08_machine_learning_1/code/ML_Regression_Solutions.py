...
initial_model_coefs = np.random.uniform(0, 1, n_features).round(2)
initial_model_intercept = np.random.uniform(0, 1, 1).round(2)
...
trained_model_intercept = model.intercept_.round(2)
trained_model_coef = model.coef_.round(2)
