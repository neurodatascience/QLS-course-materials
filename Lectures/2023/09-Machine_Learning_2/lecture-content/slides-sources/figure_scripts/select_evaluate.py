...
df = pd.DataFrame({"Accuracy": accuracies, "dataset": "2022\nWorld Cup"})
df.iloc[-1, 1] = "2026\nWorld Cup"
...
monkey = ax.text(0.1, 0.60, "🐒", fontname="Symbola", fontsize=22)
elephant = ax.text(0.1, 0.4, "🐘", fontname="Symbola", fontsize=22)
chicken = ax.text(0.0, 0.07, "🐔", fontname="Symbola", fontsize=22)
...
ax.annotate("", xytext=(a_x, a_y), xy=(b_x, b_y), arrowprops=dict(arrowstyle="->"))
